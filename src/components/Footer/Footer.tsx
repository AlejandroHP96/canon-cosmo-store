...
const getMakoLevel = (): number => {
    ...
    const level = Math.round(
        50 + 40 * Math.sin(2 * Math.PI * (normalized - 0.25)),
    );
    ...
    return (
        <footer className="fixed bottom-0 w-full z-50 flex justify-between items-center h-[var(--footer-h)] px-4 md:px-8 bg-[#010241] border-t-2 border-[#e0e0ff] font-body text-[10px] tracking-tight">
            <div className="hidden lg:flex items-center gap-3">
                ...
                <span className="text-primary tracking-[0.25em] font-headline uppercase text-[9px]">
                    Shinra Inc. Terminal
                </span>
                ...
                <span className="text-[#bec2ff]/70 font-headline uppercase tracking-widest text-[9px]">
                    Mako
                </span>
                <div className="flex items-center gap-1">
                    ...
                    <span className="text-yellow-400 font-headline text-[9px]">
                        {makoLevel}%
                    </span>
                </div>
                <span className="text-[#bec2ff]/30">|</span>
                ...
                <span className="text-green-400 font-headline tracking-widest text-[9px]">
                    ESTABLE
                </span>
                <span className="text-[#bec2ff]/30">|</span>
                ...
                <span className="text-red-400 font-headline tracking-widest text-[9px]">
                    DETECTADA
                </span>
            </div>
