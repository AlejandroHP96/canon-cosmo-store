        ...
        <div className="max-w-5xl mx-auto">
            ...
            <div className="tactical-frame p-8 mb-10 flex flex-col gap-4">
                ...
                <p className="text-sm text-on-surface-variant font-body max-w-xl leading-relaxed">
                    Tu tienda de referencia para juegos de cartas coleccionables. Encuentra
                    sobres, mazos iniciales, bundles y singles de los mejores TCGs del mercado.
                    Catálogo actualizado con las últimas expansiones.
                </p>
                <div className="flex gap-6 mt-2 pt-4 border-t border-outline-variant/30">
                    <div>
                        <p className="text-2xl font-headline font-bold text-on-surface">{TCG_CARDS.length}</p>
                        <p className="text-[9px] font-headline text-primary/60 tracking-widest uppercase">Juegos</p>
                    </div>
                    <div className="w-px bg-outline-variant/30" />
                    <div>
                        <p className="text-2xl font-headline font-bold text-on-surface">42</p>
                        <p className="text-[9px] font-headline text-primary/60 tracking-widest uppercase">Productos</p>
                    </div>
                    <div className="w-px bg-outline-variant/30" />
                    <div>
                        <p className="text-2xl font-headline font-bold text-on-surface">3</p>
                        <p className="text-[9px] font-headline text-primary/60 tracking-widest uppercase">Novedades</p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {TCG_CARDS.map((tcg) => (
                    <Link
                        ...
                        <div className={`w-full h-1 bg-linear-to-r ${tcg.accent}`} />
